...
const NavBar = () => {
  ...
  return (
    <div className="fixed w-full bottom-0 h-12 border-t border-[#303030] md:left-0 md:top-0 md:h-screen md:w-[4.5rem] md:border-r md:flex md:flex-col md:items-center md:gap-64 min-[1264px]:static min-[1264px]:w-[17rem]">
