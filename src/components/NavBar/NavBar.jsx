...
const NavBar = () => {
  ...
  return (
    <div className="fixed bottom-0 h-12 w-full border-t border-[#303030] md:left-0 md:top-0 md:flex md:h-screen md:w-[4.5rem] md:flex-col md:items-center min-[1264px]:sticky md:gap-40 lg:gap-72 xl:w-[20rem] md:border-r min-[1264px]:w-[17.5rem]">
