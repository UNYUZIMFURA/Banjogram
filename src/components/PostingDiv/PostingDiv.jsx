...
const PostingDiv = () => {
  ...
  return (
    ...
    <form className="flex h-[48vh] w-full flex-col justify-between bg-[#272727] min-[350px]:w-[21.7rem] rounded-xl min-[720px]:w-[50%] min-[720px]:h-[55vw] min-[970px]:h-[40rem] min-[970px]:w-[37rem]" >
